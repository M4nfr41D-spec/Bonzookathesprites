...
export const Pickups = {
  ...
  collect(pickup) {
    ...
    const soundType = pickup.type === 'health' ? 'health' :
                      pickup.type === 'item' ? (pickup.rarity === 'legendary' ? 'legendary' : 
                                                pickup.rarity === 'rare' ? 'rare' : 'item') :
                      pickup.type === 'scrap' ? 'scrap' : 'cell';
    State.modules?.Audio?.playPickup(soundType, pickup.x, pickup.y);
